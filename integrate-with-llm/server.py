...
def get_knowledge_base() -> str:
    """Retrieve the knowledge base containing sarcastic/funny responses to common workplace questions.

    Use this tool to find appropriate responses from the knowledge base whenever the user asks
    a workplace-related question or seeks a response suggestion.
